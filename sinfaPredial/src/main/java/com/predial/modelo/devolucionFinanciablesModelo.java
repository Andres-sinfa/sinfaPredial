...
@OrderDefault("NroAcuerdo")
public class devolucionFinanciablesModelo {
    ...
    private Integer Id_devolucionFinanciables;

	public devolucionFinanciablesModelo() {
		super();
	}

	public devolucionFinanciablesModelo(String nroAcuerdo, Integer ano, String concepto, Integer cuota, String fecha,
			...
			Integer id_devolucionFinanciables) {
		super();
		...
		Id_devolucionFinanciables = id_devolucionFinanciables;
	}
	...
	public Integer getId_devolucionFinanciables() {
		return Id_devolucionFinanciables;
	}

	public void setId_devolucionFinanciables(Integer id_devolucionFinanciables) {
		Id_devolucionFinanciables = id_devolucionFinanciables;
	}
