...
public class RecaudoDiarioModelo {
    ...
    private Integer Id_RecaudoDiario;

	public RecaudoDiarioModelo() {
		super();
	}

	public RecaudoDiarioModelo(Integer anoBanco, String banco, String f_recaudo, String codigo, String nroComprobante,
			Float vlrConcepto, Integer id_RecaudoDiario) {
		super();
		AnoBanco = anoBanco;
		this.banco = banco;
		...
		Id_RecaudoDiario = id_RecaudoDiario;
	}
	...
	public Integer getId_RecaudoDiario() {
		return Id_RecaudoDiario;
	}

	public void setId_RecaudoDiario(Integer id_RecaudoDiario) {
		Id_RecaudoDiario = id_RecaudoDiario;
	}
