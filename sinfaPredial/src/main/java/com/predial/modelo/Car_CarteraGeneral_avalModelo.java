...
public class Car_CarteraGeneral_avalModelo {
    ...
    private Integer Id_Car_CarteraGeneral_aval;

	public Car_CarteraGeneral_avalModelo(String periodo, String codigoCatastral, Integer ano, Integer cuota,
			Float avaluo, Float vlrImpuesto, Float vlrInteres, Float vlrCar, Float vlrInteresCar, Float vlrSobretasa,
			Float vlrDescuento, Float vlrCredito, Float vlrcreditoCar, Float vlrOtros, String f_Pago,
			String nroComprobante, boolean indPago, String banco, boolean indAcuerdoPago, Float ajuste, Float vlrAbonos,
			Float vlrCAR_Contrib, Float vlrIntCAR_Contrib, String tarifa, String rango, String numEstrato,
			Float aC_VlrDctoPredial, Float aC_VlrDctoIntImp, Float aC_VlrDctoCAR, Float aC_VlrDctoIntCAR,
			String codUnicoCatastral, Integer id_Car_CarteraGeneral_aval) {
		super();
		Periodo = periodo;
		...
		Id_Car_CarteraGeneral_aval = id_Car_CarteraGeneral_aval;
	}

	public Car_CarteraGeneral_avalModelo() {
		super();
	}
	...
	public Integer getId_Car_CarteraGeneral_aval() {
		return Id_Car_CarteraGeneral_aval;
	}

	public void setId_Car_CarteraGeneral_aval(Integer id_Car_CarteraGeneral_aval) {
		Id_Car_CarteraGeneral_aval = id_Car_CarteraGeneral_aval;
	}
