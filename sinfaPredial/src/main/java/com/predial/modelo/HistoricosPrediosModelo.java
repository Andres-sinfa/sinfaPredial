...
public class HistoricosPrediosModelo {
    ...
    private Integer Id_HistoricosPredios;

	public HistoricosPrediosModelo() {
		super();
	}

	public HistoricosPrediosModelo(String codigoCatastral, String propietario, Float consecutivo, String estado,
			String resolucion, Integer ano, Integer anoTarifa, Float avaluo, String nombres, String nit,
			String direccionPredio, Float areaMetros, Float areaConstruida, String tipoNit, String nroRegistros,
			String departamento, String municipio, String tipoRegistro, String destinoEconomico,
			String condicionTributaria, String radicacion, String mutacion, String dcasadaViuda, String codigoCancelado,
			String tarifa, String rango, Float anoPago, Float areaMetrosAnt, Float areaConstrAnt, Float avaluoAnterior,
			boolean ind_PorRevisar, boolean ind_Cargado, String detalle, Float avaluoAnoAnterior, Float avaluoSistema,
			Integer anoInicial, Integer cuotaInicial, boolean indLoteAnt, Float vlrDeuda, boolean ind_incorporar,
			String codUnicoCatastral, String vigencia, String matricula, Integer id_HistoricosPredios) {
		super();
		...
		Id_HistoricosPredios = id_HistoricosPredios;
	}
	...
	public Integer getId_HistoricosPredios() {
		return Id_HistoricosPredios;
	}

	public void setId_HistoricosPredios(Integer id_HistoricosPredios) {
		Id_HistoricosPredios = id_HistoricosPredios;
	}
