...
public class PrediosCanceladosModelo {
    ...
    private Integer Id_PrediosCancelados;

	public PrediosCanceladosModelo() {
		super();
	}

	public PrediosCanceladosModelo(String codigoCatastral, String propietario, Integer ano, Integer anoTarifa,
			String tarifa, String rango, Float avaluo, Integer anoAnterior, Float avaluoAnterior, Integer anoPago,
			Float vlrPagado, String f_Pago, Float vlrPagadoAnterior, String f_PagoAnterior, String nroFacturaAnterior,
			...
			String condicionTributaria, String f_proceso, String estado, String codigoCancelado,
			String codUnicoCatastral, Integer id_PrediosCancelados) {
		super();
		...
		Id_PrediosCancelados = id_PrediosCancelados;
	}
	...
	public Integer getId_PrediosCancelados() {
		return Id_PrediosCancelados;
	}

	public void setId_PrediosCancelados(Integer id_PrediosCancelados) {
		Id_PrediosCancelados = id_PrediosCancelados;
	}
